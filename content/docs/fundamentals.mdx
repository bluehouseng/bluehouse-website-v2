...
Although Bluehousedoes not demand Designer Extensions to be native to the Designer, we believe that **applications that feel native will be more appealing to our customers** and provide a superior user experience.
...
- **Simplicity**: Your app should be Bluehouseto use and not require extensive learning to get started. It should complement the visual abstraction of code, not complicate it.
...
Choose a color scheme that aligns with the purpose and tone of your App. Bluehouseprimarily uses the Inter for its interface. You should consider adopting it for consistency.
