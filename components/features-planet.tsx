...
const EventGallery = () => {
  ...
  return (
    <div className="container mx-auto p-4 mt-32 overflow-hidden">
      ...
      <div className="relative">
        <div className="flex justify-center mb-6">
          ...
          {["training", "summerTraining", "techfest2024"].map((tab) => (
            <button
              ...
              className={`px-4 py-2 mx-2 text-sm font-medium rounded-lg transition-colors duration-300 ${
                activeTab === tab
        ...
        >
          <div className="mb-8 text-center px-4 sm:px-16 md:px-32 lg:px-64">
            {activeTab === "training" && (
            ...
            {activeTab === "techfest2024" && (
              <p className="text-sm text-gray-700">
                ...
                technological advancements. The event featured insightful
                talks, interactive sessions, and groundbreaking projects that
                showcased the future of the tech industry.
              </p>
            )}
          </div>
