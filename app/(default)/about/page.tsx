...
export default function About() {
  return (
    <div className="mt-32">
      ...
      <div className="flex flex-col-reverse md:flex-row md:-space-x-32 items-center px-4 md:px-16  mt-10 space-y-8 md:space-y-0 ">
        
        <div className="flex-1 bg-gray-900/25 h-auto md:h-[495px] rounded-md p-8 md:p-20">
