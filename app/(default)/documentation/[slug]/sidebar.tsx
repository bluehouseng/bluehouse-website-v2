...
export default function Sidebar({ docs }: { docs: any[] }) {
  ...
  return (
    <>
      ...
      <Transition
        as="div"
        className="fixed inset-0 z-50 bg-gray-900 bg-opacity-20 transition-opacity md:hidden ease-out data-[closed]:opacity-0 data-[enter]:duration-200 data-[leave]:duration-100"
        show={sidebarOpen}
        aria-hidden="true"
      />
