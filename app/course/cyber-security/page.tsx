// app/course/cybersecurity/page.tsx
'use client';
  ...
  modules: [
    {
      ...
      description: 'Fundamentals of cybersecurity and its importance in the digital world',
      topics: ['What is Cybersecurity?', 'Cybersecurity Threats Landscape', 'Core Security Principles'],
    },
    {
      title: 'Network Security',
      description: 'Protecting network infrastructure from intrusions and attacks',
      topics: ['Firewalls and IDS/IPS', 'VPNs and Secure Communications', 'Network Monitoring'],
    },
    {
      title: 'Ethical Hacking',
      description: 'Understanding hacking techniques to better defend systems',
      topics: ['Penetration Testing', 'Vulnerability Assessment', 'Security Tools'],
    },
    {
      title: 'Cryptography',
      description: 'Securing information through encryption techniques',
      topics: ['Symmetric & Asymmetric Encryption', 'Hash Functions', 'Digital Signatures'],
    },
    {
      title: 'Security Operations',
      description: 'Managing and responding to security incidents',
      topics: ['SIEM Systems', 'Incident Response', 'Threat Intelligence'],
    },
    {
      title: 'Compliance and Legal Aspects',
      description: 'Understanding regulations and legal requirements',
      topics: ['GDPR', 'HIPAA', 'PCI-DSS'],
    },
  ],
};
...
export default function CybersecurityPage() {
  ...
  const [activeMenu, setActiveMenu] = useState('cybersecurity');
    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-8">
        ...
        <h1 className="text-3xl font-bold text-gray-800 mb-2">
          {cybersecurityCourse.title}
        </h1>
        <p className="text-gray-600 mb-8">{cybersecurityCourse.description}</p>
        ...
        <div className="space-y-6">
          {cybersecurityCourse.modules.map((module, index) => (
            <div
              key={index}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-500 text-sm mb-3">
                Explore essential tools and frameworks used in cybersecurity
              </p>
              <Link
                href="#"
            ...
            <div className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-500 text-sm mb-3">
                Learn about professional certifications in cybersecurity
              </p>
              <Link
                href="#"
                className="text-blue-600 text-sm font-medium flex items-center"
