...
const communityManagementCourse = {
    title: 'Community Management',
    description: 'Build vibrant and engaging online communities',
    modules: [
        {
            title: 'Understanding Online Communities',
            description: 'Types, benefits, and challenges of communities',
            topics: ['Types of Communities', 'Community Lifecycle', 'Engagement Metrics'],
        },
        {
            title: 'Community Building Strategies',
            description: 'Methods for growing and nurturing a community',
            topics: ['Member Acquisition', 'Onboarding New Members', 'Creating Community Guidelines'],
        },
        {
            title: 'Engagement and Moderation',
            description: 'Keeping the community active and safe',
            topics: ['Facilitating Discussions', 'Conflict Resolution', 'Content Moderation'],
        },
        {
            title: 'Tools and Platforms',
            description: 'Overview of community management software',
            topics: ['Discord', 'Slack', 'Forum Software', 'Social Media Management'],
        },
    ],
};
...
export default function CommunityManagementPage() {
    ...
    const [activeMenu, setActiveMenu] = useState('community-management');
            ...
            <div className="flex-1 overflow-y-auto p-8">
                ...
                <div className="bg-white rounded-lg shadow-md p-8 mb-8">
                    <h1 className="text-3xl font-bold text-gray-800 mb-2">
                        {communityManagementCourse.title}
                    </h1>
                    <p className="text-gray-600 mb-8">{communityManagementCourse.description}</p>
                ...
                <div className="space-y-6">
                    {communityManagementCourse.modules.map((module, index) => (
                        <div
                            key={index}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                            ...
                            <p className="text-gray-500 text-sm mb-3">
                                Curated reading list for {communityManagementCourse.title}
                            </p>
                            <Link
                                href="#"
                        ...
                        <div className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                            ...
                            <p className="text-gray-500 text-sm mb-3">
                                Learn about different community platforms
                            </p>
                            <Link
                                href="#"
                                className="text-blue-600 text-sm font-medium flex items-center"
