// app/course/data-science/page.tsx
'use client';
...
export default function DataSciencePage() {
  ...
  const [activeMenu, setActiveMenu] = useState('data-science');
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      {/* Sidebar */}
      <aside className={`bg-white flex-shrink-0 transition-all duration-300 h-full ${sidebarCollapsed ? 'w-20' : 'w-52'}`}>
      ...
      <div className="flex-1 overflow-y-auto p-8">
        ...
        <h1 className="text-3xl font-bold text-gray-800 mb-2">{dataScienceCourse.title}</h1>
        <p className="text-gray-600 mb-8">{dataScienceCourse.description}</p>
        ...
        <div className="space-y-6">
          {dataScienceCourse.modules.map((module, index) => (
            <div
              key={index}
        ...
        <div className="mt-12 bg-white rounded-lg shadow-md p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-500 text-sm mb-3">Curated reading list for {dataScienceCourse.title}</p>
              <a
                href="#"
