// app/course/data-analysis/page.tsx
'use client';
  ...
  modules: [
    {
      ...
      description: 'Fundamentals of data manipulation and analysis',
      topics: ['Pandas Basics', 'Data Cleaning', 'Data Exploration'],
    },
    {
      title: 'Statistical Analysis',
      description: 'Understanding and applying statistical methods',
    ...
    },
    {
      ...
      topics: ['Matplotlib', 'Seaborn', 'Tableau Basics'],
    },
    {
      title: 'SQL for Data Analysis',
      description: 'Querying and managing databases',
      topics: ['Basic SQL Queries', 'Joining Tables', 'Data Aggregation'],
    },
  ],
};
...
export default function DataAnalysisPage() {
  ...
  const [activeMenu, setActiveMenu] = useState('data-analysis');
    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-8">
        ...
        <h1 className="text-3xl font-bold text-gray-800 mb-2">
          {dataAnalysisCourse.title}
        </h1>
        <p className="text-gray-600 mb-8">{dataAnalysisCourse.description}</p>
        ...
        <div className="space-y-6">
          {dataAnalysisCourse.modules.map((module, index) => (
            <div
              key={index}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-500 text-sm mb-3">
                Curated reading list for {dataAnalysisCourse.title}
              </p>
              <Link
                href="#"
