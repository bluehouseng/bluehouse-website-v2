...
const developerRelationsCourse = {
  title: 'Developer Relations',
  description: 'Bridge the gap between developers and companies through community, content, and advocacy',
  modules: [
    {
      title: 'Introduction to Developer Relations',
      description: 'Understanding the role and impact of DevRel in tech organizations',
      topics: [
    ...
    },
    {
      ...
      description: 'Representing and advocating for developer needs',
      topics: [
    ...
    },
    {
      ...
      description: 'Creating valuable resources for developers',
      topics: [
    ...
    },
    {
      ...
      description: 'Growing and nurturing developer communities',
      topics: [
    ...
    },
    {
      ...
      description: 'Promoting products to technical audiences',
      topics: [
        'Technical Product Messaging',
        'Developer-Focused Campaigns',
        'Conference Strategies',
        'Swag and Developer Gifts'
      ],
    },
    {
      title: 'Developer Experience (DX)',
      description: 'Improving how developers interact with your product',
      topics: [
        'DX Principles and Metrics',
    ...
    },
    {
      ...
      description: 'Quantifying the impact of developer relations',
      topics: [
        'Key DevRel Metrics',
        'ROI of Developer Relations',
...
export default function DeveloperRelationsPage() {
  const [expandedCourse, setExpandedCourse] = useState<string | null>(null);
  const [sidebarCollapsed, setSidebarCollapsed] = useState(false);
  const [activeMenu, setActiveMenu] = useState('developer-relations');
    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-8">
        ...
        <h1 className="text-3xl font-bold text-gray-800 mb-2">
          {developerRelationsCourse.title}
        </h1>
        <p className="text-gray-600 mb-8">{developerRelationsCourse.description}</p>
        ...
        <div className="space-y-6">
          {developerRelationsCourse.modules.map((module, index) => (
            <div
              key={index}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
              <h3 className="font-semibold text-gray-700 mb-2">
                DevRel Community Resources
              </h3>
              <p className="text-gray-500 text-sm mb-3">
                Connect with the global DevRel community and learn from experts
              </p>
              <Link
                href="#"
            ...
            <div className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
              <h3 className="font-semibold text-gray-700 mb-2">
                DevRel Tools and Platforms
              </h3>
              <p className="text-gray-500 text-sm mb-3">
                Essential tools for documentation, community management, and analytics
              </p>
              <Link
                href="#"
                className="text-blue-600 text-sm font-medium flex items-center"
