// app/course/technical-writing/page.tsx
'use client';
...
const technicalWritingCourse = {
  title: 'Technical Writing',
  description: 'Create engaging and effective technical documentation',
  modules: [
    {
      title: 'Introduction to Technical Writing',
      description: 'Understanding the purpose and audience of technical content',
      topics: ['What is Technical Writing?', 'Identifying Your Audience', 'Planning Your Documentation'],
    },
    {
      title: 'Writing Clear and Concise Content',
      description: 'Techniques for effective communication',
      topics: ['Plain Language Principles', 'Structuring Information', 'Using Visual Aids'],
    },
    {
      title: 'Documenting Software and APIs',
      description: 'Best practices for software and API documentation',
      topics: ['API Documentation Tools', 'Writing Tutorials', 'Release Notes'],
    },
    {
      title: 'Creating User Manuals and Guides',
      description: 'Developing comprehensive user assistance materials',
      topics: ['Task-Based Documentation', 'Troubleshooting Guides', 'Accessibility in Documentation'],
    },
    {
      title: 'Tools and Technologies for Technical Writers',
      description: 'Overview of software and platforms used in the field',
      topics: ['Markdown and RST', 'Documentation Generators', 'Version Control'],
    },
  ],
};
...
export default function TechnicalWritingPage() {
  ...
  const [activeMenu, setActiveMenu] = useState('technical-writing');
    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-8">
        ...
        <h1 className="text-3xl font-bold text-gray-800 mb-2">
          {technicalWritingCourse.title}
        </h1>
        <p className="text-gray-600 mb-8">{technicalWritingCourse.description}</p>
        ...
        <div className="space-y-6">
          {technicalWritingCourse.modules.map((module, index) => (
            <div
              key={index}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-500 text-sm mb-3">
                Learn about different technical writing style guides
              </p>
              <Link
                href="#"
