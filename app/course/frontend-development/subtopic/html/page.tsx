...
<Greeting name="World" />`
  ...
  const getPreviewContent = () => {
    ...
    if (activeTab === 'javascript') return `<script>${code.javascript}</script>`;
    if (activeTab === 'react') return `<script type="text/babel">${code.react}</script>`;
    return '';
  };
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="w-1/2 p-6 overflow-auto">
        ...
        <h2 className="text-2xl font-bold mb-4">{activeTab.toUpperCase()} Examples</h2>
