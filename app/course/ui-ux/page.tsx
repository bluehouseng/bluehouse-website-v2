// app/course/ui-ux-design/page.tsx
'use client';
...
const uiUxDesignCourse = {
  title: 'UI/UX Design',
  description: 'Create seamless and visually engaging experiences',
  modules: [
    {
      title: 'Introduction to UI/UX Design',
      description: 'Understanding user-centered design principles',
      topics: ['What is UI/UX?', 'User Research Basics', 'Usability Principles'],
    },
    {
      title: 'User Research and Analysis',
      description: 'Methods for understanding user needs and behaviors',
      topics: ['User Interviews', 'Surveys and Questionnaires', 'User Personas'],
    },
    {
      title: 'Information Architecture and Wireframing',
      description: 'Structuring content and creating basic layouts',
      topics: ['Sitemap Creation', 'Card Sorting', 'Low-Fidelity Wireframing'],
    },
    {
      title: 'UI Design Principles and Tools',
      description: 'Visual design elements and software fundamentals',
      topics: ['Typography', 'Color Palette', 'Figma/Sketch Basics'],
    },
    {
      title: 'Prototyping and Testing',
      description: 'Creating interactive prototypes and gathering feedback',
      topics: ['High-Fidelity Prototyping', 'Usability Testing', 'Iteration Process'],
    },
  ],
};
...
export default function UIUXDesignPage() {
  ...
  const [activeMenu, setActiveMenu] = useState('ui-ux-design');
    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-8">
         ...
         {/* Course Header Section */}
          ...
          {uiUxDesignCourse.title}
        </h1>
        <p className="text-gray-600 mb-8">{uiUxDesignCourse.description}</p>
        ...
        <div className="space-y-6">
          {uiUxDesignCourse.modules.map((module, index) => (
            <div
              key={index}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-500 text-sm mb-3">
                Explore curated collections of beautiful UI designs
              </p>
              <Link
                href="#"
            ...
            <div className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-500 text-sm mb-3">
                Learn more about user research methodologies
              </p>
              <Link
                href="#"
                className="text-blue-600 text-sm font-medium flex items-center"
