// app/course/digital-marketing/page.tsx
'use client';
  ...
  modules: [
    {
      ...
      description: 'Fundamentals of digital marketing and its role in modern business',
      topics: [
    ...
    },
    {
      ...
      description: 'Improve organic visibility and website traffic',
      topics: [
        'Keyword Research',
    ...
    },
    {
      ...
      description: 'Leverage social platforms for brand growth and engagement',
      topics: [
        'Platform Strategies (Facebook, Instagram, LinkedIn, etc.)',
        'Content Planning',
    ...
    },
    {
      ...
      description: 'Create valuable content to attract and retain audiences',
      topics: [
    ...
    },
    {
      ...
      description: 'Run effective paid campaigns across digital platforms',
      topics: [
...
export default function DigitalMarketingPage() {
  ...
  const [activeMenu, setActiveMenu] = useState('digital-marketing');
    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-8">
        ...
        <h1 className="text-3xl font-bold text-gray-800 mb-2">
          {digitalMarketingCourse.title}
        </h1>
        <p className="text-gray-600 mb-8">{digitalMarketingCourse.description}</p>
        ...
        <div className="space-y-6">
          {digitalMarketingCourse.modules.map((module, index) => (
            <div
              key={index}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-500 text-sm mb-3">
                Essential tools for SEO, social media, email marketing, and analytics
              </p>
              <Link
                href="#"
            ...
            <div className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-500 text-sm mb-3">
                Learn from successful digital marketing campaigns across industries
              </p>
              <Link
                href="#"
                className="text-blue-600 text-sm font-medium flex items-center"
