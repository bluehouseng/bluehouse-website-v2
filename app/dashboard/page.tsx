...
const courses: Course[] = [
  { title: "Frontend Development", icon: <FaCode />, image: Frontend, description: "Build interactive and visually stunning websites...", link: "/course/frontend-developmentg" },
  ...
  { title: "Data Analysis", icon: <FaDatabase />, image: DataAnalysis, description: "Transform raw data into actionable insights...", link: "/course/data-analysis" },
  { title: "Graphics Design", icon: <FaPaintBrush />, image: GraphicsDesign, description: "Create amazing visuals with endless creativity...", link: "/course/graphic-design" },
...
const CourseCard = ({ course }: { course: Course }) => (
  <Link href={course.link}>
    <div className="bg-white rounded-lg shadow-md border hover:shadow-lg transition duration-300">
      <div className="relative h-[340] w-full">
